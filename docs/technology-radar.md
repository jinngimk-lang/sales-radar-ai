...
- Main head `273a97343caa4205cedf4e0dc0849d1babb70c68` was healthy at scan time; the latest observed production smoke for main succeeded.
- Autonomous-maintenance PR #34 CI run `32817089691` completed successfully before this radar update.
- No candidate justified replacing the current Browserbase, Crawl4AI adapter, or internal eval/trace seams.
- Added `langfuse/langfuse` as `WATCH`, not as a dependency, after verifying `v4.17.0` (2026-08-24) and its mixed core/enterprise license boundary.
