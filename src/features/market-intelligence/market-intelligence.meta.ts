...
/** Keep browser and timeline aligned while giving Live View a useful desktop viewport. */
export const MARKET_WORKSPACE_HEIGHT =
  'h-[calc(100vh-200px)] min-h-[760px] max-h-[980px]'
