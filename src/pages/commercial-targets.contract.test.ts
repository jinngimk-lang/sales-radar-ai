...
test('market radar restores an exact persisted target and records only successful runs', async () => {
  ...
  assert.match(market, /setTarget\(commercialTargetToMarketTarget\(/)
